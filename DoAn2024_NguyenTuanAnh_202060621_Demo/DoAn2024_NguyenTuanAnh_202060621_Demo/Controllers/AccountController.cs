...
namespace DoAn2024_NguyenTuanAnh_202060621_Demo.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> PostProfile(RegisterViewModel req)
        {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                DoAn2024_NguyenTuanAnh_202060621_Demo.Common.Common.SendMail("ShopOnline", "Quên mật khẩu", "Bạn click vào <a href='" + callbackUrl + "'>link này</a> để reset mật khẩu", model.Email);
