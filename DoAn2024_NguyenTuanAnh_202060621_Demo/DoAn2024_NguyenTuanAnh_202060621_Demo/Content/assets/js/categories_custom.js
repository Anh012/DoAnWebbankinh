...
jQuery(document).ready(function($)
{
	...
	*/
	...
	//	// Định dạng giá trị mặc định ban đầu
	...
	//	$("#amount").val(initialValue1 + "đ" + " - " + initialValue2 + "đ");
	//}

	// Hàm chuyển đổi số sang chuỗi với dấu chấm phân cách hàng nghìn và hàng trăm
